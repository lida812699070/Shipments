...
import com.example.ok.shipments.weixin.MD5;
import com.example.ok.shipments.weixin.Util;
...
public class WXPayActivity extends AppCompatActivity {
        ...
        appay_pre_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!(msgApi.getWXAppSupportAPI() >= Build.PAY_SUPPORTED_SDK_INT)){
                    Toast.makeText(WXPayActivity.this, "检查微信版本，当前不支持支付功能", Toast.LENGTH_SHORT).show();
                    return;
                }
                genPayReq();
            }
    ...
    private String genProductArgs() {
        ...
        try {
            ...
            packageParams.add(new BasicNameValuePair("notify_url", "http://www.xsjky.cn"));
    ...
    private void genPayReq() {
        ...
        Log.e("支付参数", signParams.toString());
